      ...
      <div class="h-full overflow-y-auto bg-white">
        ...
        <div class="p-4 sm:p-6 lg:p-8 space-y-6 lg:space-y-8">
          ...
          ${monthlyData.length > 0 ? `
            <div>
              <h3 class="text-lg font-semibold text-gray-700 mb-4">${this.t.fund.chartTitle}</h3>
              <div class="bg-gray-50 rounded-2xl p-4 lg:p-6 border border-gray-200 overflow-x-auto">
                <div class="min-w-fit">
          ...
          ` : ''}
          <div>
            <h3 class="text-lg font-semibold text-gray-700 mb-4">${this.t.fund.transactions}</h3>
            <div class="border border-gray-200 rounded-2xl overflow-hidden">
              <div class="overflow-x-auto">
                <table class="w-full text-sm">
                  <thead class="bg-gray-50 border-b border-gray-200">
                    <tr><th class="text-left px-4 lg:px-6 py-3 text-gray-500 font-medium">${this.t.fund.date}</th><th class="text-left px-4 lg:px-6 py-3 text-gray-500 font-medium">${this.t.fund.description}</th><th class="text-left px-4 lg:px-6 py-3 text-gray-500 font-medium hidden sm:table-cell">${this.t.fund.person}</th><th class="text-right px-4 lg:px-6 py-3 text-gray-500 font-medium">${this.t.fund.amount}</th></tr>
                  </thead>
