...
import type { FieldType } from './components/app-input.js';
import type { SelectOption } from './components/app-select.js';
...
const fieldTypeOptions: FieldType[] = ['text', 'number', 'date', 'url'];
        ...
        <div class="container mx-auto px-4 py-8 grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <section class="bg-white os-dark:bg-gray-800 lg:col-span-2 rounded-xl shadow p-6 space-y-6">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
              ...
              <div>
                <label class="block text-xs text-gray-500 os-dark:text-gray-400 mb-1">Amount</label>
                <input
                  type="number"
                  class="w-full px-3 py-2 text-sm border border-gray-300 os-dark:border-gray-600 rounded-lg bg-white os-dark:bg-gray-700 text-gray-800 os-dark:text-gray-200"
              ...
              <div>
                <label class="block text-xs text-gray-500 os-dark:text-gray-400 mb-1">Currency</label>
                <select
                  class="w-full px-3 py-2 text-sm border border-gray-300 os-dark:border-gray-600 rounded-lg bg-white os-dark:bg-gray-700 text-gray-800 os-dark:text-gray-200"
              ...
              <div>
                <label class="block text-xs text-gray-500 os-dark:text-gray-400 mb-1">Person Name</label>
                <input
                  type="text"
                  class="w-full px-3 py-2 text-sm border border-gray-300 os-dark:border-gray-600 rounded-lg bg-white os-dark:bg-gray-700 text-gray-800 os-dark:text-gray-200"
              ...
              <div>
                <label class="block text-xs text-gray-500 os-dark:text-gray-400 mb-1">Event Name</label>
                <input
                  type="text"
                  class="w-full px-3 py-2 text-sm border border-gray-300 os-dark:border-gray-600 rounded-lg bg-white os-dark:bg-gray-700 text-gray-800 os-dark:text-gray-200"
            ...
            <div>
              <label class="block text-xs text-gray-500 os-dark:text-gray-400 mb-1">Description</label>
              <input
                type="text"
                class="w-full px-3 py-2 text-sm border border-gray-300 os-dark:border-gray-600 rounded-lg bg-white os-dark:bg-gray-700 text-gray-800 os-dark:text-gray-200"
          ...
          <section class="bg-white os-dark:bg-gray-800 lg:col-span-2 rounded-xl shadow p-6 space-y-6">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
              <div class="flex items-center gap-2 pt-6">
                <input
                  ...
                  class="rounded border-gray-300"
                />
                <label for="modal-open" class="text-sm text-gray-700 os-dark:text-gray-300">Open</label>
              </div>
            ...
            <p class="text-xs text-gray-400">
              Close via the ✕ button, an overlay click, the Escape key, or Save/Cancel inside the body.
            </p>
              ...
              <app-modal
                ...
                .body=${html`
                  <div class="space-y-3">
                    ...
                    <div>
                      <label class="text-sm text-gray-600 dark:text-gray-300">Birth Year</label>
                      <input
                        type="number"
                        class="mt-1 w-full px-4 py-2.5 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 dark:text-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500"
                        value="${state.modalBirthYear}"
                        @input=${(e: Event) => {
                          state.modalBirthYear = (
                            e.target as HTMLInputElement
                          ).value;
                          renderPlayground();
                        }}
          ...
          <section class="bg-white os-dark:bg-gray-800 lg:col-span-2 rounded-xl shadow p-6 space-y-6">
            ...
            <div class="${state.dark ? 'dark' : ''}">
              <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 min-h-[160px] bg-white dark:bg-gray-900 rounded-xl p-4">
                <app-input
                  ...
                  @change=${() => {
                    state.lastEvent =
                      'app-input change event (bubbled to host)';
                    renderPlayground();
                  }}
                ></app-input>
                <app-select
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
              <div>
                <label class="block text-xs text-gray-500 os-dark:text-gray-400 mb-1">Field type</label>
                <select
                  class="w-full px-3 py-2 text-sm border border-gray-300 os-dark:border-gray-600 rounded-lg bg-white os-dark:bg-gray-700 text-gray-800 os-dark:text-gray-200"
                ...
                >
                  ${fieldTypeOptions.map((t) => html`<option value="${t}">${t}</option>`)}
                </select>
              </div>

              <div>
                <label class="block text-xs text-gray-500 os-dark:text-gray-400 mb-1">Field label</label>
                <input
                  type="text"
                  class="w-full px-3 py-2 text-sm border border-gray-300 os-dark:border-gray-600 rounded-lg bg-white os-dark:bg-gray-700 text-gray-800 os-dark:text-gray-200"
              ...
              <div>
                <label class="block text-xs text-gray-500 os-dark:text-gray-400 mb-1">Field placeholder</label>
                <input
                  type="text"
                  class="w-full px-3 py-2 text-sm border border-gray-300 os-dark:border-gray-600 rounded-lg bg-white os-dark:bg-gray-700 text-gray-800 os-dark:text-gray-200"
              ...
              <div>
                <label class="block text-xs text-gray-500 os-dark:text-gray-400 mb-1">Textarea rows</label>
                <input
                  type="number"
                  min="1"
                  max="10"
            ...
            <div class="flex flex-wrap items-center gap-4">
              <div class="flex items-center gap-2">
                <input
                  ...
                  class="rounded border-gray-300"
                />
                <label for="field-required" class="text-sm text-gray-700 os-dark:text-gray-300">Field required</label>
              </div>
              ...
              <div class="flex items-center gap-2">
                <input
                  ...
                  class="rounded border-gray-300"
                />
                <label for="field-disabled" class="text-sm text-gray-700 os-dark:text-gray-300">Field disabled</label>
              </div>
              ...
              <div class="flex items-center gap-2">
                <input
                  ...
                  class="rounded border-gray-300"
                />
                <label for="select-placeholder" class="text-sm text-gray-700 os-dark:text-gray-300">Show empty option</label>
              </div>
            </div>
              ...
              <button
                ...
                @click=${() => {
                  Object.assign(state, {
                    ...
                    selectShowPlaceholder: false,
                    textareaValue:
                      'Annual family gathering for the Lunar New Year.',
                    textareaRows: 3,
                    lastEvent: '',
                  });
                  renderPlayground();
            ...
            <p class="text-xs text-gray-400">
              Last event: <span class="font-mono">${state.lastEvent || '— type in a field, pick an option, or toggle a checkbox'}</span>
            </p>
          </section>
