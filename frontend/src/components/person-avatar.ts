...
import { getInitials, getGenderSymbol, isDeceased } from '../utils/format.js';
...
function getColors(gender: string): string {
  if (gender === 'M') return 'bg-blue-100 dark:bg-blue-900 text-blue-600 dark:text-blue-300';
  if (gender === 'F') return 'bg-pink-100 dark:bg-pink-900 text-pink-600 dark:text-pink-300';
